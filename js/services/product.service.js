...
export const ProductService = {
  ...
  createProduct: async (data) => {
    try {
      ...
      if (rawData && (rawData.status === 201 || rawData.data)) {
        return { success: true, product: new ProductDTO(rawData.data || rawData), message: rawData.message };
      }
      return { success: false, error: rawData?.message || "Failed to create product" };
    } catch (error) {
  ...
  updateProduct: async (id, data) => {
    try {
      ...
      if (rawData && (rawData.status === 200 || rawData.data)) {
        return { success: true, product: new ProductDTO(rawData.data || rawData) };
      }
      return { success: false, error: rawData?.message || "Failed to update product" };
    } catch (error) {
  ...
  deleteProduct: async (id) => {
    try {
      ...
      return { success: false, error: rawData?.message || "Failed to delete product" };
    } catch (error) {
  ...
  getAdminProducts: async (params = {}) => {
    try {
      ...
      return { success: false, error: rawData?.message || "Failed to fetch admin products" };
    } catch (error) {
  ...
  getTrashedProducts: async (params = {}) => {
    try {
      ...
      return { success: false, error: rawData?.message || "Failed to fetch trashed products" };
    } catch (error) {
  ...
  restoreProduct: async (id) => {
    try {
      ...
      return { success: false, error: rawData?.message || "Failed to restore product" };
    } catch (error) {
  ...
  forceDeleteProduct: async (id) => {
    try {
      ...
      return { success: false, error: rawData?.message || "Failed to force delete product" };
    } catch (error) {
      console.error(`Error in ProductService.forceDeleteProduct(${id}):`, error);
      return { success: false, error: error.message };
    }
  }
};
